...
<title>ONLINE QUIZ || Take The Quiz </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Take The Quiz</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/brian.png" width=150 height=100 alt="Brian Dias" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.instagram.com/brian.diaz22" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Brian Dias</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9588404701</h4>
		<h4 style="font-family:'typo' ">diasb7152@gmail.com</h4>
